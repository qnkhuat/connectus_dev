...
<div class="row">
    <div class="col-md-12">
      <form action="/admin/course-types/update" method="post">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="input-group">
                ...
                <input type="text" name="name" value="{{$type->name}}" id="input-name-page" class="form-control" placeholder="Name between 1 - 255 chars length" required  data-parsley-length="[1,255]">
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="radio radio-info form-check-inline">
                <input type="radio" {{$type->publish ? "checked" : ""}} id="inlineRadio1" value="1" name="publish">
                <label for="inlineRadio1"> Yes </label>
            </div>
            <div class="radio form-check-inline">
                <input type="radio" {{!$type->publish ? "checked" : ""}} id="inlineRadio2" value="0" name="publish">
