...
<div class="row">
    ...
    <div class="table-responsive min-height-250">
      <table class="table table-hover table-bordered">
        ...
        <tr>
          ...
          <td>{{$type->name}}</td>
          <td>
            {!! $type->publish ? "<span class='label label-table label-success'>yes</span>" : "<span class='label label-table label-inverse'>no</span>" !!}
          </td>
  ...
  <div class="col-sm-12">
    <div class="row">
      ...
      <div class="col-md-4">
        Course types total: {{$types->total()}}
      </div>
    </div>
...
<script>
  ...
  function destroyUser(type_id, name) {
