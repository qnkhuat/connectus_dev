...
<div class="row">
    <div class="col-md-12">
      <form action="/admin/districts/update" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="input-group">
                ...
                <input type="text" name="key" value="{{$district->key}}" maxlength="1" id="input-name-page" class="form-control" placeholder="Only 1 chars length" required  data-parsley-length="[1,255]">
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="input-group">
                ...
                <input type="text" name="name" value="{{$district->name}}" id="input-name-page" class="form-control" placeholder="Name between 1 - 255 chars length" required  data-parsley-length="[1,255]">
            </div>
          </div>
        </div>
