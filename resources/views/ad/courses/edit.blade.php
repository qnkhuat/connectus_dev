...
<div class="row">
    <div class="col-md-12">
      <form action="/hi/courses/update" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="input-group">
                ...
                <input type="text" name="day_in_week" value="{{$course->day_in_week}}" id="input-name-page" class="form-control" data-parsley-length="[1,255]" placeholder="2, 3, 5">
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="input-group">
                ...
                <input type="number" required name="session_per_week" value="{{$course->session_per_week}}" id="input-name-page" class="form-control" data-parsley-length="[1,255]">
            </div>
          </div>
        </div>
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <select multiple="multiple" required class="multi-select" id="my_multi_select1" name="districts_array_id[]" data-plugin="multiselect">
                  ...
                  <option value="{{$district->id}}" {{in_array($district->id, $districtsChoosen) ? "selected" : ""}}>{{$district->name}}</option>
                  @endforeach
              </select>
            </div>
          </div>
